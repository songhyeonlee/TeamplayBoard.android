...
//    ProgressBar pbAddProjcet;
        ...
        btnAddProject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (p_name.equals("") || p_name.isEmpty()) {
                    ...
                    DatabaseReference myRef = database.getReference("user").child(uid).child("MY projects").child(p.getProject_duedate() + " : " + p.getProjectName());
                    ...
                    myRef2.child(key).setValue(project);
                    showSuccess();
                }
            }
        });
    ...
    private void showCancel() {
        ...
        builder.setNegativeButton("아니오", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                Toast.makeText(Create_Project.this, "프로젝트 생성을 계속 진행합니다.",
